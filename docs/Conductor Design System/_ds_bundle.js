...
function IconButton({
  ...
  const tint = variant === "danger" ? "var(--state-fail)" : variant === "ai" ? "var(--text-ai)" : selected ? "var(--accent)" : hover ? "var(--text-primary)" : "var(--text-secondary)";
  const bg = selected ? "var(--accent-quiet)" : active ? "var(--glass-active)" : hover ? "var(--glass-hover)" : variant === "glass" ? "var(--glass-1)" : "transparent";
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    "aria-label": label,
...
function Kbd({
  ...
  }, rest), list.map((k, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      display: "inline-flex",
      alignItems: "center",
...
function Select({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      border: "var(--border-hair) solid " + (focus ? "var(--accent)" : hover ? "var(--edge-strong)" : "var(--edge-2)"),
      boxShadow: "var(--shadow-inset-top)",
      color: "var(--text-primary)",
      opacity: disabled ? 0.45 : 1,
      transition: "var(--t-hover)",
...
function ChatComposer({
  ...
  }, rest), context ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "var(--space-3)",
  ...
  }, context), /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "x",
    size: 11,
    color: "var(--text-tertiary)",
    style: {
  ...
  }), /*#__PURE__*/React.createElement(__ds_scope.Kbd, null, "\u2318 + \u21B5"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Send",
    onClick: send,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/ChatComposer.jsx", error: String((e && e.message) || e) }); }
...
function ChatMessage({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
  ...
  }, rest), !user ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "var(--space-3)"
  ...
  }, "Conductor")) : null, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }), "Reading the accessibility tree\u2026") : children), code ? /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: "var(--radius-md)",
      background: "var(--glass-sunken)",
      border: "var(--border-hair) solid var(--ai-edge)",
  ...
  }, codeLabel), onCopy ? /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "copy",
    size: 12,
  ...
  }, code), onInsert ? /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    onClick: onInsert,
    fullWidth: true
  }, "Insert into flow")) : null) : null);
}
Object.assign(__ds_scope, { ChatMessage });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/ChatMessage.jsx", error: String((e && e.message) || e) }); }
...
function DeviceMirror({
  ...
  }, /*#__PURE__*/React.createElement("span", null, "12:29"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 5
  ...
  }, children, highlight ? /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: highlight.x,
      top: highlight.y,
  ...
  }, highlightLabel ? /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      left: -1,
      top: -19,
  ...
  }, highlightLabel) : null) : null, overlay), showNavBar ? /*#__PURE__*/React.createElement(NavBar, {
    chrome: chrome
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/DeviceMirror.jsx", error: String((e && e.message) || e) }); }
...
function DeviceSelector({
  ...
  }, "\xB7 ", platform)), /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "chevrons-up-down",
    size: 13,
    color: "var(--text-tertiary)"
  }));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/DeviceSelector.jsx", error: String((e && e.message) || e) }); }
...
function Node({
  ...
  }, isDir ? /*#__PURE__*/React.createElement(__ds_scope.Icon, {
  ...
  }, node.name), node.badge ? /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: "auto",
      font: "var(--type-mono-label)",
      color: "var(--text-disabled)"
    }
  }, node.badge) : null), isDir && open && node.children ? node.children.map(c => /*#__PURE__*/React.createElement(Node, {
    key: c.id,
    node: c,
    depth: depth + 1,
    expanded: expanded,
...
function FileTree({
  ...
  }, rest), nodes.map(n => /*#__PURE__*/React.createElement(Node, {
    key: n.id,
    node: n,
    depth: 0,
    expanded: expanded,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/FileTree.jsx", error: String((e && e.message) || e) }); }
...
function Entry({
  ...
  }, run.startedAt), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-body-strong)",
      color: "var(--text-primary)",
      flex: 1,
  ...
  }, run.flow), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 4,
...
function Step({
  ...
  }, step.label), open && step.detail ? /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-code-sm)",
      color: tint,
      whiteSpace: "pre-wrap",
  ...
  }, step.detail) : null), step.duration ? /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: "var(--text-disabled)",
      flex: "none",
...
function LogStream({
  ...
  }, runs.map(r => /*#__PURE__*/React.createElement(React.Fragment, {
    key: r.id
  }, /*#__PURE__*/React.createElement(Entry, {
    run: r,
    onSelect: onSelectRun,
    selected: r.id === selectedRunId
  }), r.id === selectedRunId ? steps.map((s, i) => /*#__PURE__*/React.createElement(Step, {
    key: s.id || i,
    step: s
  })) : null))), footer);
}
Object.assign(__ds_scope, { LogStream });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/LogStream.jsx", error: String((e && e.message) || e) }); }
...
function RunBar({
  ...
  }, rest), extra, /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), envOptions.length ? /*#__PURE__*/React.createElement(__ds_scope.Select, {
    size: "sm",
    icon: "variable",
    value: env,
    options: envOptions,
    onChange: onEnvChange
  }) : null, running ? /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "danger",
    icon: "circle-stop",
    onClick: onStop
  }, "Stop") : /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "primary",
    icon: "play",
    onClick: onRun
  }, "Run Test"), onRunAll ? /*#__PURE__*/React.createElement(__ds_scope.Button, {
    icon: "list-checks",
    onClick: onRunAll,
    disabled: running
  }, "Run All Tests") : null, /*#__PURE__*/React.createElement(__ds_scope.IconButton, {
    icon: "chevron-down",
    label: "Run options",
    size: "md",
    variant: "glass"
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/RunBar.jsx", error: String((e && e.message) || e) }); }
...
function Row({
  ...
  }, test.name), test.open ? /*#__PURE__*/React.createElement("span", {
  ...
  }) : null, test.aiAuthored ? /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "sparkles",
    size: 11,
    color: "var(--text-ai)",
  ...
  }, test.steps), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: test.lastResult === "never" ? "var(--text-disabled)" : "var(--text-tertiary)"
    }
  }, test.lastResult === "never" ? "never run" : test.lastRun), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: test.lastResult === "fail" ? "var(--state-fail)" : "var(--text-tertiary)",
      textAlign: "right"
    }
  }, test.duration || "—"), /*#__PURE__*/React.createElement("span", {
    style: {
...
function TestList({
  ...
  if (!tests.length && emptyState) return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      display: "grid",
      minHeight: 0,
      ...style
  ...
  }), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null, "flow"), /*#__PURE__*/React.createElement("span", {
    style: {
      textAlign: "right"
    }
  }, "steps"), /*#__PURE__*/React.createElement("span", null, "last run"), /*#__PURE__*/React.createElement("span", {
    style: {
      textAlign: "right"
    }
  }, "time"), /*#__PURE__*/React.createElement("span", null)), /*#__PURE__*/React.createElement("div", {
    style: {
      overflow: "auto",
      minHeight: 0,
      flex: 1
    }
  }, tests.map(t => /*#__PURE__*/React.createElement(Row, {
    key: t.id,
    test: t,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/TestList.jsx", error: String((e && e.message) || e) }); }
...
function TitleBar({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
  ...
  }, rest), showTrafficLights ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, LIGHTS.map(l => /*#__PURE__*/React.createElement("span", {
    key: l.key,
    "aria-label": l.key,
    style: {
      display: "grid",
    ...
    strokeLinecap: "round",
    fill: "none"
  }))))) : null, leading ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 2,
  ...
  }, center, !center && projectPath ? /*#__PURE__*/React.createElement("div", {
    onMouseEnter: () => setHover(true),
    onMouseLeave: () => setHover(false),
    style: {
      display: "flex",
  ...
  }, projectPath), /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "chevron-down",
    size: 12,
    color: "var(--text-disabled)"
  })) : null), /*#__PURE__*/React.createElement("div", {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/TitleBar.jsx", error: String((e && e.message) || e) }); }
...
function tokenize(line) {
  ...
  if (m) {
    ...
    const rest = m[5];
    if (rest) {
      if (/^\s*(true|false|null|\d+(\.\d+)?)\s*$/.test(rest)) push("number", rest);else push("string", rest);
    }
  } else {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        background: isError ? "var(--state-fail-quiet)" : isAi ? "var(--ai-quiet)" : isActive ? "var(--editor-active-line)" : "transparent",
        boxShadow: isAi ? "inset 2px 0 0 0 var(--ai)" : isError ? "inset 2px 0 0 0 var(--state-fail)" : "none",
    ...
    }, tokenize(text).map((tk, j) => /*#__PURE__*/React.createElement("span", {
      key: j,
      style: {
        color: COLORS[tk.t]
      }
    }, tk.v)), isActive ? /*#__PURE__*/React.createElement("span", {
      style: {
        display: "inline-block",
        width: 1.5,
        height: "1.05em",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/studio/YamlEditor.jsx", error: String((e && e.message) || e) }); }
...
function Row({
  ...
  const [hover, setHover] = React.useState(false);
  if (item.type === "separator") return /*#__PURE__*/React.createElement("div", {
    style: {
      height: 1,
      margin: "4px 6px",
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    name: item.icon,
    size: 14,
    color: hover && !off ? "var(--accent-on)" : item.destructive || item.ai ? tint : "var(--text-tertiary)"
  }) : /*#__PURE__*/React.createElement("span", {
    style: {
      width: 14
    }
  ...
  }, item.shortcut) : null, item.submenu ? /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: "chevron-right",
    size: 12,
...
function ContextMenu({
  ...
  }, title)) : null, items.map((item, i) => /*#__PURE__*/React.createElement(Row, {
    key: item.id || i,
    item: item,
    onSelect: onSelect
  })));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/ContextMenu.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/Dialog.jsx", error: String((e && e.message) || e) }); }
...
function GlassPanel({
  ...
  }, rest), sheen && !sunken ? /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      position: "absolute",
      inset: 0,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/GlassPanel.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/PanelHeader.jsx", error: String((e && e.message) || e) }); }
...
function TabStrip({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    }, t.label), t.dirty ? /*#__PURE__*/React.createElement("span", {
      style: {
        width: 5,
        height: 5,
        borderRadius: "var(--radius-pill)",
    ...
    }) : null, onClose ? /*#__PURE__*/React.createElement("span", {
      role: "button",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/TabStrip.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surface/Toolbar.jsx", error: String((e && e.message) || e) }); }
...
const {
  Icon
} = window.ConductorDesignSystem_527814;
...
function OrderCard({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, a11y("card" + index, "View", "Pedido " + code, 'id: "order-card-' + index + '"'), {
    style: {
      borderRadius: 12,
  ...
  }, /*#__PURE__*/React.createElement("span", _extends({}, a11y("due" + index, "Text", "Preparar até " + due, 'text: "Preparar até ' + due + '"'), {
    style: {
      font: "var(--w-medium) 12px/1.3 var(--font-ui)",
      color: "oklch(78% 0.004 265)"
    }
  }), "Preparar at\xE9 ", due), /*#__PURE__*/React.createElement("span", _extends({}, a11y("open" + index, "Button", "Abrir pedido " + code, 'id: "order-open-' + index + '"'), {
    style: {
      display: "grid",
      placeItems: "center",
      width: 22,
    ...
    name: "chevron-right",
    size: 12
  }))), /*#__PURE__*/React.createElement("span", _extends({}, a11y("code" + index, "Text", code, 'text: "' + code + '"'), {
    style: {
      font: "var(--w-semibold) 14px/1.3 var(--font-ui)",
      color: "oklch(97% 0.001 265)",
      justifySelf: "start"
    }
  }), code), /*#__PURE__*/React.createElement("span", _extends({}, a11y("person" + index, "Text", person, 'text: "' + person + '"'), {
    style: {
  ...
  }, /*#__PURE__*/React.createElement("span", _extends({}, a11y("mode" + index, "Text", mode, 'text: "' + mode + '"'), {
    style: {
      font: "var(--w-regular) 12px/1.3 var(--font-ui)",
      color: "oklch(62% 0.006 265)",
      justifySelf: "start"
  ...
  }, /*#__PURE__*/React.createElement("span", _extends({}, a11y("items" + index, "Text", items, 'text: "' + items + '"'), {
    style: {
      font: "var(--w-regular) 12px/1.3 var(--font-ui)",
      color: "oklch(70% 0.005 265)"
    }
...
function AppUnderTest() {
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", _extends({}, a11y("title", "Text", "Pedidos pendentes", 'text: "Pedidos pendentes"'), {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 5,
  ...
  }), "Pedidos pendentes", /*#__PURE__*/React.createElement(Icon, {
    name: "chevron-down",
    size: 13,
    color: "oklch(70% 0.005 265)"
  })), /*#__PURE__*/React.createElement("span", _extends({}, a11y("search", "Button", "Buscar", 'id: "search-button"'), {
    style: {
      display: "grid",
      placeItems: "center",
      width: 24,
    ...
    name: "search",
    size: 17
  })), /*#__PURE__*/React.createElement("span", _extends({}, a11y("menu", "Button", "Menu", 'id: "orders-menu"'), {
    style: {
      display: "grid",
      placeItems: "center",
      width: 24,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/AppUnderTest.jsx", error: String((e && e.message) || e) }); }
...
function CDoctorSheet({
  ...
  }, "Doctor"), /*#__PURE__*/React.createElement("p", {
    style: {
      font: "var(--type-body)",
      color: "var(--text-secondary)"
    }
  }, "What Conductor needs on this Mac. Checked at every launch.")), /*#__PURE__*/React.createElement(DocIconButton, {
    icon: "x",
    label: "Close",
    size: "sm",
    onClick: onClose
  ...
  }, DOCTOR_GROUPS.map(g => /*#__PURE__*/React.createElement("section", {
    key: g.label,
    style: {
      display: "grid",
      gap: 6
  ...
  }, g.rows.map((r, i) => /*#__PURE__*/React.createElement(CDoctorRow, {
    key: r.name,
    row: r,
  ...
  }, g.note) : null))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, "Checked Aug 4, 9:12 am"), /*#__PURE__*/React.createElement(DocButton, {
    variant: "ghost",
    icon: "refresh-cw"
  }, "Check again"), /*#__PURE__*/React.createElement(DocButton, {
    variant: "primary",
    onClick: onClose
  }, "Done")))));
}
...
function CDoctorBadge({
  count,
  onClick,
  selected
}) {
  if (!count) return /*#__PURE__*/React.createElement(DocTooltip, {
    content: "Doctor"
  ...
  return /*#__PURE__*/React.createElement(DocTooltip, {
    content: name
...
function CDoctorInstaller() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Setting up Conductor"), /*#__PURE__*/React.createElement("p", {
    style: {
      font: "var(--type-body)",
      color: "var(--text-secondary)",
      marginTop: 6,
  ...
  }, "Installing Maestro, the runner behind every test. This happens once."), /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      height: 4,
      marginTop: 26,
    ...
    style: {
      ...
      transition: "width var(--dur-base) linear, background var(--dur-base) var(--ease-out)"
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, done ? /*#__PURE__*/React.createElement(DocIcon, {
    name: "check",
    size: 13,
    color: "var(--state-pass)"
  }) : null, /*#__PURE__*/React.createElement("span", {
  ...
  }, done ? "maestro 1.39.9 is ready" : step), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: "var(--text-disabled)"
    }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/CDoctor.jsx", error: String((e && e.message) || e) }); }
...
function docBRows() {
  const all = [];
  (window.DOCTOR_GROUPS || []).forEach(g => g.rows.forEach(r => all.push({
    ...r,
    group: g.label
  })));
  return {
...
function CDoctorRowB({
  ...
  }, full ? row.detail : row.short)), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-caption)",
      color: row.status === "ok" ? "var(--text-tertiary)" : s.color
    }
...
function CDoctorSheetB({
  ...
  }, "Doctor"), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: "var(--text-tertiary)"
    }
  }, "checked 9:12 am"), /*#__PURE__*/React.createElement(DocBIconButton, {
    icon: "x",
    label: "Close",
    size: "sm",
    onClick: onClose
  ...
  }, verdict.title), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-body)",
      color: "var(--text-secondary)",
      textWrap: "pretty"
  ...
  }, issues.length ? /*#__PURE__*/React.createElement(CDoctorSectionB, {
    label: "Needs you"
  }, issues.map((r, i) => /*#__PURE__*/React.createElement(CDoctorRowB, {
    key: r.name,
    row: r,
    full: true,
    last: i === issues.length - 1
  }))) : null, /*#__PURE__*/React.createElement(CDoctorSectionB, {
    label: "Ready"
  }, ready.map((r, i) => /*#__PURE__*/React.createElement(CDoctorRowB, {
    key: r.name,
    row: r,
  ...
  }, "Maestro is the only one Conductor installs and updates by itself. The rest live on your machine, and signing in is always yours to do.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "flex-end",
  ...
  }, /*#__PURE__*/React.createElement(DocBButton, {
    variant: "ghost",
    icon: "refresh-cw"
  }, "Check again"), /*#__PURE__*/React.createElement(DocBButton, {
    variant: "primary",
    onClick: onClose
  }, "Done")))));
}
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/CDoctorB.jsx", error: String((e && e.message) || e) }); }
...
function CFlowRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      alignItems: "center",
      gap: 9,
      padding: "6px 6px 6px " + (9 + depth * 14) + "px",
      borderRadius: "var(--a-radius-surface)",
      cursor: "pointer",
  ...
  }, test.steps, " steps \xB7 ", test.duration || "never run")), hover || selected ? /*#__PURE__*/React.createElement(IconButton, {
    icon: "ellipsis",
    label: "Flow actions",
    size: "sm",
    onClick: e => {
  ...
  }) : test.change ? /*#__PURE__*/React.createElement(Tooltip, {
    content: test.change === "new" ? "New — not sent yet" : "Changed — not sent yet"
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      width: 5,
      height: 5,
  ...
  })) : test.aiAuthored ? /*#__PURE__*/React.createElement(Icon, {
    name: "sparkles",
    size: 12,
    color: "var(--ai)"
  }) : null);
...
function CFolderRow({
  ...
  }, !open && unsent ? /*#__PURE__*/React.createElement("span", {
    style: {
      width: 5,
      height: 5,
      borderRadius: 999,
...
function CDisclosure({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      overflow: "hidden",
      height: open ? h + "px" : 0,
      minHeight: open ? h + "px" : 0,
      transition: "height var(--dur-base) var(--ease-out), min-height var(--dur-base) var(--ease-out)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    ref: inner,
    style: {
...
function CDraftRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      alignItems: "center",
      gap: 8,
      padding: "5px 7px 5px " + (7 + depth * 14) + "px",
      borderRadius: "var(--a-radius-surface)",
      background: "var(--a-well)",
      border: "1px solid " + (error ? "var(--state-fail)" : "var(--accent-edge)"),
      boxShadow: error ? "none" : "var(--glow-accent)"
    }
  }, /*#__PURE__*/React.createElement(Icon, {
    name: kind === "folder" ? "folder" : "file-code",
    size: 13,
    color: error ? "var(--state-fail)" : "var(--accent)"
    ...
    style: {
      font: "var(--type-caption)",
      color: "var(--state-fail)",
      padding: "0 8px 2px " + (8 + depth * 14) + "px"
    }
  }, error) : null);
}
function CFlows({
  ...
  const folders = s.folders.map(f => ({
    name: f,
    items: shown.filter(t => t.folder === f)
  })).filter(f => f.items.length || !q);
  const loose = shown.filter(t => !t.folder);
  const draft = s.newItem;
  const draftRow = folder => draft && draft.folder === folder ? /*#__PURE__*/React.createElement(CDraftRow, {
    key: "draft-" + folder,
    kind: draft.kind,
    depth: folder ? 1 : 0,
    value: draft.value,
    error: draft.error,
    onChange: v => s.setNewItem({
      ...draft,
      value: v,
      error: null
    }),
  ...
  const row = (t, depth) => s.renameItem && s.renameItem.kind === "flow" && s.renameItem.id === t.id ? /*#__PURE__*/React.createElement(CDraftRow, {
    key: t.id,
    kind: "flow",
    depth: depth,
    value: s.renameItem.value,
    error: s.renameItem.error,
    onChange: v => s.setRenameItem({
      ...s.renameItem,
      value: v,
      error: null
    }),
    ...
    onOpen: s.openTest,
    onMenu: (id, e) => s.setRowMenu({
      id,
      x: e.clientX,
      y: e.clientY
    })
  });
  const folderRow = f => s.renameItem && s.renameItem.kind === "folder" && s.renameItem.id === f.name ? /*#__PURE__*/React.createElement(CDraftRow, {
    kind: "folder",
    value: s.renameItem.value,
    error: s.renameItem.error,
    onChange: v => s.setRenameItem({
    ...
    onCommit: s.commitRename,
    onCancel: () => s.setRenameItem(null)
  }) : /*#__PURE__*/React.createElement(CFolderRow, {
    name: f.name,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, q ? shown.map(t => row(t, 0)) : /*#__PURE__*/React.createElement(React.Fragment, null, folders.map(f => /*#__PURE__*/React.createElement(React.Fragment, {
    key: f.name
  }, folderRow(f), /*#__PURE__*/React.createElement(CDisclosure, {
    open: !collapsed[f.name]
  }, f.items.map(t => row(t, 1)), draftRow(f.name), f.items.length || draft && draft.folder === f.name ? null : /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: () => s.startNew("flow", f.name),
    style: {
      display: "flex",
      alignItems: "center",
      gap: 7,
    ...
    size: 11,
    color: "var(--text-disabled)"
  }), "Empty \u2014 add a flow")))), loose.map(t => row(t, 0)), draftRow("")), !shown.length && q ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "20px 12px",
      font: "var(--type-caption)",
      color: "var(--text-disabled)",
    ...
    size: 12,
    color: "var(--text-tertiary)"
  }), "Run whole suite"), unsent ? /*#__PURE__*/React.createElement(Tooltip, {
    content: unsent === 1 ? "1 change not sent yet" : unsent + " changes not sent yet"
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      alignItems: "center",
  ...
  }), unsent)) : null, /*#__PURE__*/React.createElement(Tooltip, {
    content: "Settings"
  }, /*#__PURE__*/React.createElement(IconButton, {
    icon: "settings",
    label: "Settings",
    size: "sm"
  }))), newMenu ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 70
  ...
  })) : null, folderMenu ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      zIndex: 70
...
function CTab({
  ...
  }, tab.label), tab.dirty ? /*#__PURE__*/React.createElement("span", {
    style: {
      width: 5,
      height: 5,
      borderRadius: 999,
  ...
  }) : null, active || hover ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      flex: "none"
    }
...
function CTabStrip({
  ...
  }, s.tabs.map(t => /*#__PURE__*/React.createElement(CTab, {
    key: t.id,
    tab: t,
...
function CSubTabs({
  ...
  }, t.label, t.id === "run" && running ? /*#__PURE__*/React.createElement("span", {
    style: {
      width: 5,
      height: 5,
      borderRadius: 999,
...
function CRunPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, s.steps.map((step, i) => /*#__PURE__*/React.createElement("div", {
    key: step.id || i,
    style: {
      position: "relative",
      display: "grid",
    ...
    style: {
      ...
      boxShadow: step.status === "running" ? "0 0 0 4px var(--state-running-quiet)" : "0 0 0 3px var(--a-content)"
    }
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-code-sm)",
...
function CAssistantPanel({
  ...
  }, s.thread.map((m, i) => /*#__PURE__*/React.createElement(ChatMessage, {
    key: i,
    role: m.role,
    code: m.code,
    onInsert: m.code ? () => s.insert(m.code) : undefined,
    onCopy: m.code ? () => {} : undefined
  }, m.body)), s.busy ? /*#__PURE__*/React.createElement(ChatMessage, {
    pending: true
  }) : null, s.thread.length === 1 ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 6
    }
  }, ["Open the first pending order", "Assert both order cards are visible", "Screenshot after checkout"].map(p => /*#__PURE__*/React.createElement("button", {
    key: p,
    type: "button",
    onClick: () => s.ask(p),
    style: {
...
function CEditorColumn({
  ...
  }, s.lower === "run" ? /*#__PURE__*/React.createElement(CRunPanel, {
    s: s
...
function CDevice({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ref: headRef,
    style: HEADER
  }, roomy ? /*#__PURE__*/React.createElement("span", {
    style: {
      ...CAPS,
      flex: "none"
    }
  }, "Device") : null, /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, s.device.serial)), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), tools ? /*#__PURE__*/React.createElement(Tooltip, {
    content: "Reload",
    shortcut: "\u2318R"
  }, /*#__PURE__*/React.createElement(IconButton, {
    icon: "refresh-cw",
    label: "Reload mirror",
    size: "sm"
  })) : null, tools ? /*#__PURE__*/React.createElement(Tooltip, {
    content: "Screenshot"
  }, /*#__PURE__*/React.createElement(IconButton, {
    icon: "camera",
    label: "Screenshot",
  ...
  }, /*#__PURE__*/React.createElement(DeviceMirror, {
    style: fit.transform,
    width: fit.width,
    height: fit.height,
...
function revChanges(tests) {
  return (tests || []).filter(t => t.change).map(t => ({
    ...t,
    kind: CHANGE_KIND[t.change]
  }));
}
...
function CSendControl({
  ...
  if (phase === "review") return /*#__PURE__*/React.createElement(RevTooltip, {
    content: "Waiting for review \xB7 sent 2 min ago"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onClick,
    onMouseEnter: () => setHover(true),
    ...
    style: {
      ...base,
      background: hover ? "var(--glass-hover)" : "var(--a-well)",
      border: "1px solid var(--a-hair)",
      color: "var(--text-secondary)"
    }
  }, /*#__PURE__*/React.createElement(RevIcon, {
    name: "clock",
    size: 13,
    color: "var(--text-tertiary)"
  }), "Waiting for review", count ? /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: "var(--accent)"
    }
  }, "+", count) : null));
  if (!count) return /*#__PURE__*/React.createElement("span", {
    style: {
      ...base,
      cursor: "default",
  ...
  return /*#__PURE__*/React.createElement(RevTooltip, {
    ...
    size: 13,
    color: "var(--accent-on)"
  }), "Send changes", /*#__PURE__*/React.createElement("span", {
    style: {
      display: "grid",
      placeItems: "center",
      minWidth: 16,
...
function CSendRow({
  ...
  }, "conductor/", c.folder ? c.folder + "/" : "")), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-caption)",
      color: c.kind.color
    }
...
function CSendSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      flex: "none",
      borderRadius: "var(--a-radius-field)",
      background: sent ? "var(--a-well)" : "var(--accent-quiet)",
      color: sent ? "var(--text-tertiary)" : "var(--accent)"
    }
  }, /*#__PURE__*/React.createElement(RevIcon, {
    name: sent ? "clock" : "send",
    size: 15
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, sent ? "Waiting for review" : changes.length === 1 ? "Send 1 change" : "Send " + changes.length + " changes"), /*#__PURE__*/React.createElement("p", {
    style: {
      font: "var(--type-body)",
      color: "var(--text-secondary)",
      textWrap: "pretty"
    }
  }, sent ? window.REVIEWER.name + " will look at these and put them in the shared project. You can keep working — new changes join the same review." : "Your work is already saved on this Mac. Sending puts it in front of " + window.REVIEWER.name + ", who adds it to the shared project.")), sending ? null : /*#__PURE__*/React.createElement(RevIconButton, {
    icon: "x",
    label: "Close",
    size: "sm",
    onClick: onClose
  ...
  }, changes.map((c, i) => /*#__PURE__*/React.createElement(CSendRow, {
    key: c.id,
    c: c,
    last: i === changes.length - 1
  }))), sent ? null : /*#__PURE__*/React.createElement("label", {
    style: {
      display: "grid",
      gap: 6
    }
  ...
  }, "What changed? ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--text-disabled)"
    }
  }, "Optional \u2014 it helps the reviewer.")), /*#__PURE__*/React.createElement("textarea", {
    value: note,
    ...
    size: 12,
    color: "var(--text-disabled)"
  }), "conductor/"), sent ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(RevButton, {
    variant: "ghost"
  }, "View on GitHub"), /*#__PURE__*/React.createElement(RevButton, {
    variant: "primary",
    onClick: onClose
  }, "Done")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(RevButton, {
    variant: "ghost",
    onClick: onClose,
    disabled: sending
  }, "Not yet"), /*#__PURE__*/React.createElement(RevButton, {
    variant: "primary",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/CReview.jsx", error: String((e && e.message) || e) }); }
...
function useStudioC(opts = {}) {
  ...
  React.useEffect(() => {
    const onKey = e => {
      ...
      if (meta && e.key.toLowerCase() === "n") {
        e.preventDefault();
        startNew(e.shiftKey ? "folder" : "flow", "");
      }
      if (e.key === "Escape") {
        setMenu(null);
        setRowMenu(null);
  ...
  const run = () => {
    ...
    commands.forEach((c, i) => {
      later(() => {
        setSteps(s => [...s.map(x => x.status === "running" ? {
          ...x,
          status: "pass",
          duration: "0:0" + (1 + i % 2)
        } : x), {
  ...
  const commitNew = () => {
    ...
    if (newItem.kind === "folder") {
      if (taken(folders, raw)) return setNewItem({
        ...newItem,
        error: "A folder called “" + raw + "” already exists."
      });
      setFolders(f => [...f, raw]);
      setCollapsed(c => ({
        ...c,
    ...
    if (taken(siblings, name)) return setNewItem({
      ...newItem,
  ...
  const commitRename = () => {
    ...
    if (renameItem.kind === "folder") {
      ...
      if (taken(folders, raw)) return setRenameItem({
        ...renameItem,
        error: "A folder called “" + raw + "” already exists."
      });
      setFolders(f => f.map(x => x === renameItem.id ? raw : x));
      setTests(t => t.map(x => x.folder === renameItem.id ? {
        ...x,
        folder: raw,
        change: x.change || "edited"
      } : x));
    ...
    if (taken(siblings, name)) return setRenameItem({
      ...renameItem,
      error: "“" + name + "” already exists in this folder."
    });
    setTests(t => t.map(x => x.id === self.id ? {
      ...x,
      name,
      change: x.change || "edited"
    } : x));
    setTabs(t => t.map(x => x.id === self.id ? {
      ...x,
      label: name
    } : x));
    setRenameItem(null);
  ...
  return {
    ...
    startRename: (kind, id) => {
      ...
      setRenameItem({
        kind,
        id,
        value: kind === "folder" ? id : (tests.find(t => t.id === id) || {}).name || "",
        error: null
      });
    },
    ...
    confirmDelete: () => {
      if (!confirm) return;
      if (confirm.kind === "folder") deleteFolder(confirm.id);else deleteFlow(confirm.id);
      setConfirm(null);
    },
    deleteFolder,
    flows,
    ...
    openTest: id => {
      ...
      if (!test) return;
      setTabs(t => t.some(x => x.id === id) ? t : [...t, {
        id,
        label: test.name
      }]);
      setActiveTab(id);
...
function CCommandMenu({
  ...
  window.COMMAND_GROUPS.forEach((g, gi) => {
    ...
    g.commands.forEach(c => items.push({
      id: c,
      label: c,
      icon: ACTION_ICONS[c],
      mono: true
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    items: items,
    onSelect: item => {
      if (item.id === "__ai") s.ask("What can I assert about " + node.selector + "?");else s.appendStep(item.id, node);
      s.setMenu(null);
    }
  }));
}
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    onSelect: item => {
      ...
      if (item.id === "new") {
        ...
        s.startNew("flow", src && src.folder || "");
      }
      if (item.id === "run") {
...
function CDevices({
  ...
  }, d.serial), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-caption)",
      color: "var(--text-tertiary)"
    }
  }, d.model)), d.serial === s.device.serial ? /*#__PURE__*/React.createElement(Icon, {
    name: "check",
    size: 14,
    color: "var(--accent)"
...
function CConfirmDelete({
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    ...
    subtitle: folder ? inside.length ? "The folder and the " + inside.length + (inside.length === 1 ? " flow" : " flows") + " in it are removed from conductor/. This cannot be undone here." : "The folder is removed from conductor/. This cannot be undone here." : "The flow is removed from conductor/. This cannot be undone here.",
    ...
    name: folder ? "folder" : "file-code",
    size: 13,
    color: "var(--text-tertiary)"
  }), "conductor/" + name), inside.length ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 3,
      paddingLeft: 21
    }
  }, inside.slice(0, 4).map(t => /*#__PURE__*/React.createElement("span", {
    key: t.id,
    style: {
      font: "var(--type-mono-label)",
      color: "var(--text-tertiary)"
    }
  }, t.name)), inside.length > 4 ? /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-mono-label)",
      color: "var(--text-disabled)"
    }
  }, "+", inside.length - 4, " more") : null) : null));
}
...
function CToolbar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 12,
    color: "var(--text-tertiary)"
  }), s.env, /*#__PURE__*/React.createElement(Icon, {
    name: "chevron-down",
    size: 12,
    color: "var(--text-tertiary)"
  })), /*#__PURE__*/React.createElement("button", {
    ...
    size: 13,
    color: s.running ? "var(--state-fail)" : "var(--accent-on)"
  }), s.running ? "Stop" : "Run"), /*#__PURE__*/React.createElement("span", {
    style: {
      width: 1,
      height: 20,
      background: "var(--a-hair)"
    }
  }), /*#__PURE__*/React.createElement(window.CSendControl, {
    count: s.unsent.length,
    phase: s.sendPhase,
    onClick: () => s.setSendOpen(true)
  }), /*#__PURE__*/React.createElement(Tooltip, {
...
function StudioC({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      transition: "width var(--dur-slow) var(--ease-out), opacity var(--dur-base) var(--ease-out)",
      zIndex: 5
    }
  }), s.flows ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(CFlows, {
    s: s
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      background: "var(--a-hair)"
    }
  })) : null, /*#__PURE__*/React.createElement(CEditorColumn, {
    s: s
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      background: "var(--a-hair)"
  ...
  }), /*#__PURE__*/React.createElement(window.CSendSheet, {
    open: s.sendOpen,
    phase: s.sendPhase,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/CShell.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/data.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/conductor-c-aurora/useInspector.jsx", error: String((e && e.message) || e) }); }
