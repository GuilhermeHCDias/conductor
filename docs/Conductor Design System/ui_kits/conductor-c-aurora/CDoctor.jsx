    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="a-scroll"
            style={{ overflowY: 'auto', display: 'grid', gap: 14, padding: '2px 16px 16px' }}
          >
            {DOCTOR_GROUPS.map((g) => (
              <section key={g.label} style={{ display: 'grid', gap: 6 }}>
                ...
                >
                  {g.rows.map((r, i) => (
                    <CDoctorRow key={r.name} row={r} last={i === g.rows.length - 1} />
                  ))}
                </div>
                {g.note ? (
                  <p
          ...
          >
            <span
              style={{ font: 'var(--type-mono-label)', color: 'var(--text-tertiary)', flex: 1 }}
            >
              Checked Aug 4, 9:12 am
            </span>
            <DocButton variant="ghost" icon="refresh-cw">
              Check again
            </DocButton>
            <DocButton variant="primary" onClick={onClose}>
              Done
            </DocButton>
          </div>
        </div>
...
function CDoctorBadge({ count, onClick, selected }) {
  ...
  return (
    <DocTooltip
      content={count === 1 ? 'Doctor · 1 item needs you' : 'Doctor · ' + count + ' items need you'}
    >
      <button
        type="button"
        onClick={onClick}
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span
          style={{ width: 12, height: 12, borderRadius: 999, background: 'var(--a-hair-strong)' }}
        />
        <span
          style={{ width: 12, height: 12, borderRadius: 999, background: 'var(--a-hair-strong)' }}
        />
      ...
      >
        ...
        <h1 style={{ font: 'var(--type-title-2)', color: 'var(--text-primary)', marginTop: 18 }}>
        ...
        <div
          style={{ display: 'flex', alignItems: 'center', gap: 6, width: '100%', marginTop: 10 }}
        >
