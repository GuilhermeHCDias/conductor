...
export const CONFIG = {
  ...
  /** Teto de gasto de uma invocação de describe (§8.4): perfil apertado, para
   * uma tarefa de uma frente só. A conversa do AIPanel não tem teto (§6.4 como
   * emendada) — este é o único que sobra, e não é de conversa nenhuma. */
